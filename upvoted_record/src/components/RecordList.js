...
const RecordList = ({ records, setRecords, setEditedRecord }) => {
  ...
  return (
    <Box className="right-section" style={{ marginTop: '20px', backgroundColor: '#fff', padding: '20px', borderRadius: '8px',marginRight:'15px', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }}>
    ...
    <Box className="records-container" style={{ display:'flex',justifyContent:'space-between',alignItems:'center',width:'100%'}}> 
    <Box className="records" style={{ width: '100%', overflowY: 'auto' }}>
